...
const Greeting = () => {
    return (
        <div className="mt-[140px] pt-[40px] pb-[100px] bg-transparent bg-gradient-to-b from-white to-[#efefef] relative">
            ...
            {/* Nền uốn lượn với clip-path */}
            <div className="absolute bottom-0 left-0 w-full h-[150px] bg-[#efefef] clip-path-[polygon(0%_0%,100%_0%,100%_100%,0%_90%)]"></div>
        </div>
    );
}
